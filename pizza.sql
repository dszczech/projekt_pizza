...
--
-- Host: 127.0.0.1
-- Czas generowania: 13 Cze 2020, 13:07
...
INSERT INTO `items` (`id`, `name`, `img`, `price`, `description`, `rating`, `quantity`) VALUES
(1, 'Pizza Chorizo', 'img/burger/1.png', 28, 'salami chorizo', 1, 1),
(2, 'Pizza Funghi', 'img/burger/2.png', 24, 'pieczarki', 17, 5),
(3, 'Pizza Gamberi', 'img/burger/3.png', 33, 'z 8 krewetkami', 0, 0),
(4, 'Pizza Verdura', 'img/burger/4.png', 27, 'prawdziwe włoskie cienkie ciasto, pulpa pomidorowa, ser mozzarella z zalewy, Grana Padano ,czarne oliwki, pomidorki cherry, rukola i świeża bazylia', 24, 6),
(5, 'Pizza Prosciutto e Funghi', 'img/burger/5.png', 27, 'z pieczarkami i włoską szynką', 0, 0),
(6, 'Pizza Americana', 'img/burger/6.png', 40, 'z włoską szynką, włoskim salami, pieczarkami, pomidorkami cherry i kukurydzą', 13, 3),
(7, 'Pizza Parma', 'img/burger/7.png', 37, 'z szynka parmeńską, rukolą, pomidorkami cherry i świeżą bazylią', 0, 0),
(8, 'Pizza Fumo', 'img/burger/8.png', 41, 'z 8 krewetkami, włoską szynką i świeżą bazylią', 5, 1);
...
INSERT INTO `user` (`id`, `name`, `surname`, `email`, `city_id`, `password`, `account_created`) VALUES
(49, 'hubert', 'hubert', 'hubert@o2.pl', 92, '$argon2id$v=19$m=65536,t=4,p=1$WG54V3NUVWJIbXJzR0FnLg$Wwwi2Qh3uCAZRPAHS2dP456EXoGeL5S9ip4tsoHbGNI', '2020-06-08 15:23:19'),
(50, 'dominik', 'dominik', 'dominik@o2.pl', 92, '$argon2id$v=19$m=65536,t=4,p=1$OFhxNmNObTFWdk1hN0xVZw$rHYpM1WrJx8DZ/yDQy0XU4PEz7KGeYL9GeePWuxtsSk', '2020-06-08 16:47:04'),
(51, 'igor', 'staszak', 'igorsta@o2.pl', 92, '$argon2id$v=19$m=65536,t=4,p=1$Q3VTZnVRWExTb3djVHRWaw$BOIRW28JgcvYK5tnUtU5Mk57MvDyJabxY6VHhpncYUI', '2020-06-08 17:05:36'),
(56, 'hubert', 'hubert', 'tomasz@o2.pl', 92, '$argon2id$v=19$m=65536,t=4,p=1$Y085SlVMR2hOL1VodEhJcA$l1ZpKooXuAdMEFD2yhCk9fQlE/dB0BnHCrsnC8lkFTU', '2020-06-08 17:16:37'),
(65, 'szymon', 'szymon', 'szymon@o2.pl', 92, '$argon2id$v=19$m=65536,t=4,p=1$UG5ld2VSN2M5bGFjUmJ6Nw$khhOMvlrSw67vOBiXsrdO+ZBhfR5FrIjmNqjFHEyq/w', '2020-06-10 17:12:07');
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `order_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`);
