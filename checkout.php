				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/burger/1.png"  style="width:80px;height:85px"; alt="flag">Nazwa picki</div>
                            <div class="visit"></div>
                            
						
                            <div class="visit"></div>
                            <div class="visit"><a>Cena picki</a></div>
                            <div class="visit"></div>
                            <div class="visit"><a title="Remove" href="#"><span href="#" class="iconify" data-icon="entypo:cross" data-inline="false" style="color: red;"></span></a></div>
							</div>
						</div>
